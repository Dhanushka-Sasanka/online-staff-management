...
<%@page import="com.osms.service.impl.EmployeeServiceImpl"%>
<%@page import="com.osms.service.EmployeeService"%>
								...
								<div class="col-sm-10">
									<c:if test="${employee == null}">
										<input type="text" class="form-control" id="employeeID"
											value="${nextID}" name="employeeID" readonly="readonly">
									</c:if>
									<c:if test="${employee != null}">
										<input type="text" class="form-control" id="employeeID"
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="fullname"
										name="fullname" value="<c:out value='${employee.fullName}'/>">
								</div>
							</div>
